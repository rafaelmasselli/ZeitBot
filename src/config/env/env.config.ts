...
export class EnvConfig implements IConfig {
  ...
  constructor() {
    ...
    this.DATABASE_URL =
      process.env.DATABASE_URL || "mongodb://localhost:27017/zeitbot";
    ...
    this.NEWS_EMBEDDINGS_CRON_INTERVAL =
      process.env.NEWS_EMBEDDINGS_CRON_INTERVAL || "*/10 * * * *";
    this.WHATSAPP_CRON_INTERVAL =
      process.env.WHATSAPP_CRON_INTERVAL || "0 8 * * *";
    this.WHATSAPP_AI_CRON_INTERVAL =
      process.env.WHATSAPP_AI_CRON_INTERVAL || "0 8 * * *";
