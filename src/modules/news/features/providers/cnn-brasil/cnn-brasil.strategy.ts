...
import {
  ICnnBrasilRssResponse,
  ICnnBrasilRssItem,
} from "./cnn-brasil.interface";

export class CnnBrasilStrategy {
  public parseFromRss(response: ICnnBrasilRssResponse): NewsEntity[] {
    const items: ICnnBrasilRssItem[] =
    ...
    for (const item of items) {
      ...
      news.enterprise = NewsPlatform.CNN_BRASIL;
  ...
  private extractTopics(item: ICnnBrasilRssItem): string[] {
